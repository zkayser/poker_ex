defmodule PokerEx.EvaluatorTest do
  use ExUnit.Case
  alias PokerEx.Card
  alias PokerEx.GameEngine.Evaluator
  doctest Evaluator
  ...
  describe "evaluate_hand" do
    ...
    test "evaluate_hand detects a royal_flush" do
      ...
      table =
        [:queen_of_spades, :four_of_hearts, :seven_of_diamonds, :king_of_spades, :ace_of_spades]
        |> Enum.map(&Card.from_atom/1)

      royal_flush =
        [:ten_of_spades, :jack_of_spades, :queen_of_spades, :king_of_spades, :ace_of_spades]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects straight flushes" do
      ...
      table =
        [:six_of_clubs, :seven_of_clubs, :eight_of_clubs, :jack_of_hearts, :nine_of_clubs]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:five_of_clubs, :six_of_clubs, :seven_of_clubs, :eight_of_clubs, :nine_of_clubs]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects four of a kind" do
      ...
      table =
        [:two_of_hearts, :seven_of_diamonds, :king_of_hearts, :ace_of_spades, :king_of_clubs]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:king_of_clubs, :king_of_diamonds, :king_of_hearts, :king_of_spades, :ace_of_spades]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects full houses" do
      ...
      table =
        [:ten_of_hearts, :ten_of_spades, :queen_of_spades, :queen_of_diamonds, :eight_of_diamonds]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:queen_of_hearts, :queen_of_spades, :queen_of_diamonds, :ten_of_diamonds, :ten_of_hearts]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects flushes" do
      ...
      table =
        [:two_of_diamonds, :ace_of_spades, :ten_of_clubs, :jack_of_diamonds, :queen_of_diamonds]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects straights" do
      ...
      table =
        [:ten_of_diamonds, :jack_of_spades, :two_of_hearts, :queen_of_clubs, :ace_of_spades]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:eight_of_clubs, :nine_of_hearts, :ten_of_diamonds, :jack_of_spades, :queen_of_clubs]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects three of a kind" do
      ...
      table =
        [:five_of_clubs, :ten_of_hearts, :queen_of_clubs, :six_of_spades, :two_of_diamonds]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:five_of_diamonds, :five_of_hearts, :five_of_clubs, :queen_of_clubs, :ten_of_hearts]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects two pair" do
      ...
      table =
        [:three_of_diamonds, :king_of_hearts, :ten_of_spades, :ten_of_diamonds, :five_of_clubs]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:king_of_hearts, :king_of_spades, :ten_of_diamonds, :ten_of_spades, :five_of_clubs]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects one pair" do
      ...
      table =
        [:seven_of_clubs, :five_of_diamonds, :jack_of_hearts, :king_of_spades, :three_of_spades]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:king_of_diamonds, :king_of_spades, :jack_of_hearts, :ten_of_spades, :seven_of_clubs]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "evaluate_hand detects high card appropriately" do
      ...
      table =
        [:seven_of_clubs, :five_of_hearts, :three_of_spades, :two_of_diamonds, :four_of_clubs]
        |> Enum.map(&Card.from_atom/1)

      hand =
        [:queen_of_diamonds, :nine_of_spades, :seven_of_clubs, :five_of_hearts, :four_of_clubs]
        |> Enum.map(&Card.from_atom/1)
  ...
  describe "EVALUATING HANDS OF THE SAME TYPE: " do
    test "the owner of the highest card should win for flushes" do
      ...
      table =
        [:three_of_spades, :six_of_spades, :nine_of_spades, :jack_of_hearts, :nine_of_diamonds]
        |> Enum.map(&Card.from_atom/1)
    ...
    test "a full_house should always be a full_house, even with low pairs" do
      ...
      table =
        set_table(:jack_of_clubs, :two_of_clubs, :nine_of_hearts, :ace_of_spades, :nine_of_spades)
